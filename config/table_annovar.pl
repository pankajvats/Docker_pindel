...
our $REVISION = '$Revision: 6e8fd10a90415a1cad4d829194d40f35d4ce2c26 $';
our $DATE =	'$Date: 2016-05-11 10:54:48 -0700 (Wed, 11 May 2016) $';  
...
sub geneOperation {
	...
	#generate gene anno
	my $sc;
	$sc = "annotate_variation.pl -geneanno -buildver $buildver -dbtype $protocol --splicing_threshold 3 -outfile $tempfile.$protocol -exonsort $queryfile $dbloc";
...
=head1 SYNOPSIS
 ...
 Version: $Date: 2016-05-11 10:54:48 -0700 (Wed, 11 May 2016) $
